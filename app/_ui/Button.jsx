export default function Button({ children, type = "primary"  , onClick}) {
  const styles = {
    ...
    secondary:
      "px-8 py-4 rounded-lg border border-primary-default/80 dark:border-primary-default/80 hover:bg-dark-default/5 dark:hover:bg-light-default/5 text-dark-default dark:text-light-default font-semibold text-lg transition-all active:scale-95 backdrop-blur-sm",
    secondarySmall:
